/* Grupo Varoch · Rueda de Valores corporativos compartida
   ...
   Nota: el fondo del anillo en dark lo aporta gv-navbar-theme.js (.nav-score-ring::before). */
(function () {
    'use strict';
    ...
    function init() {
        ...
        wrap.innerHTML = ''
            + '<div class="nav-score-ring" style="background:conic-gradient(' + color + ' ' + pct + '%, #EEF3F8 ' + pct + '%);">'
            +   '<span style="color:' + color + ';">' + val.toFixed(2) + '</span>'
            + '</div>'
