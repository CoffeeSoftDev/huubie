    ...
    <ul class="space-y-4 p-6" id="menuSidebar">
        ...
        <li class="text-gray-400 submenu">
            ...
            <ul class="mt-2 pl-4 space-y-2 max-h-0 overflow-hidden transition-all duration-300 ease-in-out">
                <li><a href="/alpha/eventos" class="hover:text-white block w-full">Eventos</a></li>
                <li><a href="/alpha/pedidos" class="hover:text-white block w-full">Pedido</a></li>
                <li><a href="/alpha/reservaciones" class="hover:text-white block w-full">Reservaciones</a></li>
                <li><a href="/alpha/calendario" class="hover:text-white block w-full">Calendario</a></li>
            </ul>
        </li>
    </ul>
</div>