...
if (isset($_SESSION['USR'])) {
    header('Location: /coffee/subsidiaries/');
    exit();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/coffee/src/img/huubie192.png">
    ...
    <script src="/coffee/src/js/complementos.js?t=<?= time() ?>"></script>
    <script src="/coffee/src/js/plugins.js?t=<?= time() ?>"></script>
    <script src="/coffee/src/js/coffeeSoft.js?t=<?= time() ?>"></script>
</head>
