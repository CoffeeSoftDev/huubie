...
<head>
    ...
    <script src="/coffee/menus/src/js/navbar.js"></script>
    <script src="/coffee/menus/src/js/sidebar.js"></script>
</head>
...
<body class="bg-[#111928] h-screen" data-bs-theme="dark">
    ...
    <script src="/coffee/menus/src/js/cards.js?t=<?php echo time(); ?>"></script>
    <script src="/coffee/menus/src/js/menu.js?t=<?php echo time(); ?>"></script>
</body>
