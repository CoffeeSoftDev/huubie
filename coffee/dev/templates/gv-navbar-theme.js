...
(function () {
    ...
    function injectCSS() {
        ...
        var css = ''
            ...
            + '.navbar-main.nav-dark { border-bottom-color:rgba(255,255,255,.12) !important; --nav-score-track:rgba(255,255,255,.22); }'
            + '.navbar-main.nav-dark .nav-score-ring { --score-fill:var(--score-color-dark, var(--score-color)); }'
