        ...
        <section class="pg-chat">
            <header class="pg-pane-head">
                ...
                <div class="pg-pane-head-actions">
                    ...
                    <button id="pgDelThreadBtn" class="pg-iconbtn" title="Eliminar este hilo de conversación">
            ...
            <div class="ia-drawer-input pg-chat-input">
                <!-- Chips de conexión pegajosa (base y carpeta) de la conversación.
                     Reusan los estilos .ia-db-chip de visor.css. -->
                <div id="pgDbChip" class="ia-db-chip" style="display:none;"></div>
                <div id="pgFolderChip" class="ia-db-chip" style="display:none;"></div>
                ...
                <div class="ia-input-hint">
                    ...
                    <!-- Menú "Tools": planear + interruptores de BD/archivos, apilados
                         en un popover para no saturar la barra del input. -->
                    <div class="pg-tools-menu">
                        <button id="pgToolsToggle" class="ia-editor-toggle" title="Tools del agente: planear, base de datos y archivos" aria-expanded="false">
                        ...
                        <div class="pg-tools-pop" id="pgToolsPop">
                            ...
                            <button id="pgDbToolsToggle" class="pg-toolitem" title="Tools de base de datos (run_select y conexión automática al nombrar una base)">
                                <i data-lucide="database" class="w-3.5 h-3.5"></i>
                                <span class="pg-toolitem-label">Base de datos</span>
                                <i data-lucide="check" class="pg-toolitem-check w-3.5 h-3.5"></i>
                            </button>
                            <button id="pgFsToolsToggle" class="pg-toolitem" title="Tools de archivos (list_dir/read_file/grep_files y conexión automática al nombrar una carpeta)">
                                <i data-lucide="folder-search" class="w-3.5 h-3.5"></i>
                                <span class="pg-toolitem-label">Archivos</span>
                                <i data-lucide="check" class="pg-toolitem-check w-3.5 h-3.5"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <select id="pgModelSelect" class="ia-model-pill" title="Modelo activo">
                        ...
                        <optgroup label="Ollama Cloud">
                            <option value="qwen3-coder:480b-cloud" data-tools="1">Qwen3 Coder 480B (código · módulos ⭐)</option>
                            <option value="glm-5.2:cloud" data-tools="1">GLM 5.2 (código)</option>
                            <option value="glm-5:cloud" data-tools="1">GLM 5 (flagship)</option>
                            <option value="glm-5.1:cloud" data-tools="1">GLM 5.1 (código)</option>
                            <option value="glm-4.7:cloud" data-tools="1">GLM 4.7 (código)</option>
                            ...
                            <option value="gpt-oss:120b-cloud" data-tools="1">GPT-OSS 120B (razonamiento)</option>
                            ...
                            <option value="kimi-k2.5:cloud" data-tools="1">Kimi K2.5 (agéntico · vision)</option>
                            ...
                            <option value="minimax-m3:cloud" data-tools="1">MiniMax M3 (vision · débil en módulos)</option>
                        </optgroup>
