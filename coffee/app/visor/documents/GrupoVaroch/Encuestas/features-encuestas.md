---
name: features-encuestas
description: 
date: 2026-06-20
---

## MODULO - ENCUESTAS REALIZADAS

**\*\*Contenedor layout\*\***

\- Verificar que el visor sea adaptado a una tablet.

**\*\* Visor de encuesta\*\***

~\- Quitar el color de calificacion dejarlo en color negro~

~\- Debajo del puesto de la columna responsable agregar a la persona encargada~
...
**\*\* Editar/Aplicar evaluación**

\- Revisar la funcionalidad de las tarjetas 

\- Verificar que se vea correcto en una tablet.

\- Tiene un border muy grueso en el visor de la evaluación

## MODULO - REPORTE DE ENCUESTAS
