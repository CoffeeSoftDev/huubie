...
console.log(IMAGE_ASSETS_PATH);
const getToastContent = ({ type, title, message }) => `
<div class="toast_content" style="border-left: 3px solid ${toastTypeColorCodeMap[type]}">
    <img src="https://erp-varoch.com/ERP2/src/plugin/crispy-notify/${IMAGE_ASSETS_PATH}/${type}.${ASSET_TYPE_TO_USE}" alt="" class="toast_type_asset" />
