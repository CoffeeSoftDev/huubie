...
<body data-bs-theme="dark">
    ...
    <div id="main__content" class="h-[full-screen] transition-all duration-500 bg-[#111928] text-white ">
        <div class="main-container mt-5" id="root"></div>
    </div>
    ...
    <script src="src/js/coffee.js"></script>
    <!-- <script src="src/js/sub-eventos.js"></script> -->
</body>
