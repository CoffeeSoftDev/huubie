...
>>>>>>> 9169c1dffd84758f2f0b5f9de4602b6e3c88c2ed
$(async () => {
...
class App extends Templates {
        ...
        return `
            <div class="bg-[#2C3E50] rounded-lg p-3 relative">
                ...
                <div class="flex items-start gap-6 pr-32">
                    <!-- Image -->
                    <div class="w-40 h-40 rounded-2xl overflow-hidden bg-[#D8B4E2] flex-shrink-0">
                        ${this.renderProductImage(product)}
                    </div>

                    <!-- Name and Price -->
                    <div class="flex-1">
                        <h4 class="text-white font-bold text-2xl mb-2 uppercase">${product.name || 'Producto sin nombre'}</h4>
                        <p class="text-blue-400 font-semibold text-xl mb-4">$${parseFloat(product.price || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} c/u</p>
                ...
                <div class="absolute bottom-5 right-6 text-right">
                    ...
                    <p class="text-white font-bold text-3xl">$${total.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                </div>
            </div>
        `;
    }
    ...
    createPersonalizedCard(product) {
        ...
        return `
        <div class="bg-[#2C3E50] rounded-lg p-3 border-2 border-purple-500/30 relative">
