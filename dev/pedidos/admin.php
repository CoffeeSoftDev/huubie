...
<head>
    ...
    .ui-autocomplete {
        z-index: 99999 !important;
        background: #23262f !important;   /* Gris-violeta muy oscuro */
        color: #fff !important;
    ...
    .ui-menu-item-wrapper:hover {
        background: #2c2f37 !important;    /* Un gris oscuro discreto */
        color: #fff !important;
        font-weight: 500;
    ...
    .ui-menu-item-wrapper.ui-state-active,
    .ui-menu-item-wrapper:hover {
        background: #2c2f37 !important;    /* Gris oscuro discreto */
        color: #fff !important;
