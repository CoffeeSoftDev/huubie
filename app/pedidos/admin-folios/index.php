...
<head>
    ...
    <title>Administrador de Folios</title>
    ...
    <script>
        // Override de useFetch para ajustar rutas relativas del submódulo.
        ...
        // Este módulo gestiona folios de todas las sucursales: la navbar no
        // debe mostrar el selector de sucursal.
        window.HIDE_SUBSIDIARY_SWITCH = true;
    </script>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <!-- Init -->
    <script src="src/js/admin-folios.js?t=<?php echo time(); ?>"></script>
</body>
