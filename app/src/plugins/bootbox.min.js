!(function (t, e) {
    ...
    let l = { en: { OK: "OK", CANCEL: "Cancel", CONFIRM: "OK" } },
        u = {
            dialog: '<div class="bootbox modal" tabindex="-1" role="dialog" aria-hidden="true"><div class="modal-dialog"><div class="modal-content bg-[#1F2A37]"><div class="modal-body"><div class="bootbox-body"></div></div></div></div></div>',
