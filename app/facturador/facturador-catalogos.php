...
<head>
    ...
    <title>Facturador SAT — Catalogos</title>
...
<body class="bg-ink-100 text-ink-900" data-bs-theme="light">
    ...
    <script src="/app/facturador/src/js/sample_facturador-catalogos.js?t=<?php echo time(); ?>"></script>
    <script src="/app/facturador/src/js/facturador-catalogos.js?t=<?php echo time(); ?>"></script>
</body>
