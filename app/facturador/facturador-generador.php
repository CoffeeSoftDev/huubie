...
<head>
    ...
    <title>Facturador SAT — Generador</title>
...
<body class="bg-ink-100 text-ink-900" data-bs-theme="light">
    ...
    <div id="mainContainer" class="w-full h-full transition-all duration-500 bg-ink-100 text-ink-900 mt-16">
        <div class="bg-ink-100" id="root"></div>
    </div>

    <script src="/app/facturador/src/js/sample_facturador-generador.js?t=<?php echo time(); ?>"></script>
    <script src="/app/facturador/src/js/facturador-generador.js?t=<?php echo time(); ?>"></script>
</body>
