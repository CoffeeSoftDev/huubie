...
<head>
    ...
    <title>Facturador SAT — Tickets</title>
...
<body class="bg-ink-100 text-ink-900" data-bs-theme="light">
    ...
    <script src="/app/facturador/src/js/sample_facturador-tickets.js?t=<?php echo time(); ?>"></script>
    <script src="/app/facturador/src/js/facturador-tickets.js?t=<?php echo time(); ?>"></script>
</body>
