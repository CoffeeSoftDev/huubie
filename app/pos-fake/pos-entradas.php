...
<head>
    ...
    <title>POS — Visor de Entradas</title>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/pos-fake/src/js/sample_entradas.js?t=<?php echo time(); ?>"></script>
    <script src="/app/pos-fake/src/js/pos-entradas.js?t=<?php echo time(); ?>"></script>
</body>
