...
<head>
    ...
    <link rel="stylesheet" href="/app/access/src/css/logout.css">
</head>
...
<body class="bg-[#111928] flex items-center justify-center min-h-screen">
    ...
    <div class="hidden lg:flex w-1/2 items-center justify-center">
        <img src="/app/src/img/logo/huubie.svg" alt="Logo" class="w-[50%] object-cover">
    </div>
    ...
    <script src="/app/access/src/js/logout.js"></script>
</body>
</html>
