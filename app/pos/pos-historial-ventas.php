...
<head>
    ...
    <title>POS — Cuentas de Ventas</title>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/pos/src/js/sample_json.js?t=<?php echo time(); ?>"></script>
    <script src="/app/pos/src/js/pos-historial-ventas.js?t=<?php echo time(); ?>"></script>
</body>
