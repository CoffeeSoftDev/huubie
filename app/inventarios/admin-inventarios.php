...
<head>
    ...
    <title>Inventarios — Administrador</title>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/inventarios/src/js/sample_admin-inventarios.js?t=<?php echo time(); ?>"></script>
    <script src="/app/inventarios/src/js/admin-inventarios.js?t=<?php echo time(); ?>"></script>
</body>
