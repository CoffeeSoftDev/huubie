...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/inventarios/src/js/sample_movimientos.js?t=<?php echo time(); ?>"></script>
    <script src="/app/inventarios/src/js/pos-movimientos.js?t=<?php echo time(); ?>"></script>
</body>
