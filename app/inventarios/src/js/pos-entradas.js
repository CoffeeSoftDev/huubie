...
class EntradasView extends Templates {
    ...
    entradaForm(options) {
        ...
        function saveFormato() {
            ...
            const modalId = `${opts.id}_saveFormatoModal`;

            const scopeRadios = SAMPLE_FORMATO_SCOPES.map((s, i) => `
                <label class="flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer border transition-all
                    ...
                    <span class="text-[11px] font-medium text-gray-200">${esc(s.label)}</span>
                </label>`).join('');
                        ...
                        <div class="px-4 pt-4 pb-3 flex flex-col gap-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <input id="${modalId}_name" type="text" maxlength="80" autocomplete="off"
                                    ...
                                    placeholder="${esc(opts.labels.nombreLbl)}...">
                            </div>
                            <div class="flex flex-col gap-1.5">
                                <label class="text-[10px] font-semibold uppercase tracking-wider text-gray-400">
                                    ${esc(opts.labels.scopeLbl)}
                                </label>
                                <div class="flex flex-col gap-1.5">
                                    ${scopeRadios}
                                </div>
            ...
            $(`#${modalId}`).on('click', '[data-sf-backdrop]', closeModal);
            ...
            $(`#${modalId}_name`).on('keydown', function (e) {
