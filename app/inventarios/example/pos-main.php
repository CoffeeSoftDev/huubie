...
<head>
    ...
    <title>POS &mdash; Punto de Venta</title>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/inventarios/example/src/js/sample_pos-main.js?t=<?php echo time(); ?>"></script>
    <script src="/app/inventarios/example/src/js/pos-main.js?t=<?php echo time(); ?>"></script>
</body>
