...
<head>
    ...
    <title>Inventarios &mdash; Ajustes</title>
...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <script src="/app/inventarios/example/src/js/sample_inventarios-ajustes.js?t=<?php echo time(); ?>"></script>
    <script src="/app/inventarios/example/src/js/inventarios-ajustes.js?t=<?php echo time(); ?>"></script>
</body>
