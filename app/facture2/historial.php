...
<head>
    ...
    <title>Huubie · Terminal Wansoft — Historial</title>
...
<body class="h-screen flex flex-col overflow-hidden ws-app" data-bs-theme="light">
    <!-- La banda se rotula con el modulo y ofrece el regreso al menu de administracion,
         que es de donde se entra al registro. -->
    <div id="menu-navbar" data-modulo="Historial" data-back="/app/facture2/admin.php"></div>
    ...
    <script src="/app/facture2/src/js/historial.js?t=<?php echo time(); ?>"></script>
</body>
