...
<head>
    ...
    <title>Huubie · Terminal Wansoft — Ventas</title>
...
<body class="h-screen flex flex-col overflow-hidden ws-app" data-bs-theme="light">
    ...
    <div id="menu-navbar" data-modulo="Ventas" data-back="/app/facture2/?view=inicio"></div>
    ...
    <!-- Modulo Ventas: el archivo del Facturador, sin duplicar -->
    <script src="/app/facture2/src/js/ventas.js?t=<?php echo time(); ?>"></script>
</body>
