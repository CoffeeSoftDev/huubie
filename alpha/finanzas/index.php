...
<body class="bg-[#111928] text-white" data-bs-theme="dark">
    ...
    <!-- Finanzas Module -->
    <script src="<?=PATH_FINANZAS?>src/js/finanzas.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_FINANZAS?>src/js/finanzas-ingresos.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_FINANZAS?>src/js/finanzas-compras.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_FINANZAS?>src/js/finanzas-egresos.js?t=<?php echo time(); ?>"></script>
</body>
