...
class ctrl extends mdl {
   ...
   function editUser() {
    ...
    if (isset($_FILES['photo']) && $_FILES['photo']['error'] == UPLOAD_ERR_OK) {
        ...
        // Obtener datos previos del usuario para eliminar la foto anterior
        ...
        // Preparar nombre y ruta de la nueva foto
    ...
    // Construcción del arreglo de datos para actualizar
    $data = [
        'fullname' => $fullname,
        'user'     => $user,
        'phone'    => $phone,
    ...
    // Si hubo foto nueva, se agrega al dataset
    if (!empty($photoPath)) {
    ...
    // Respuesta final hacia frontend
    return [
        'status'  => $status,
        'message' => $message,
        $data,
