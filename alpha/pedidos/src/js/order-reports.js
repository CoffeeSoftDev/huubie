...
class OrderReports extends Templates {
    ...
    layout() {
        ...
        this.tabLayout({
            ...
            json: [
                ...
                {
                    id: "cierre",
                    tab: "Reportes de Cierre",
                    onClick: () => this.renderCierreReport()
                },
            ]
        });
    ...
    // de cerrar dia ni abrir/cerrar turno. El filtro global de periodo no aplica aqui
    // (un cierre es de un dia puntual), por eso se oculta y el tab trae su propio filtro.
    renderCierreReport() {
        $('#filterBarOrderReports').hide();
