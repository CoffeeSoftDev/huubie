...
class App extends Templates {
        ...
        this.createfilterBar({
            ...
            data: [
                ...
                },
                {
                    ...
                    class: "col-12 col-md-2",
                    data: [
                        { id: "0", valor: "Todas las categorías" },
                        ...cat
                    ],
                    text: "classification",
                    value: "id",
    ...
    async addProducto() {
        let dataCat = await useFetch({ url: api, data: { opc: "init" } });
...
class Client extends Templates {
    ...
    lsClient() {
        this.createTable({
            ...
            data: { opc: "listClient", active: $("#filterbar-client #active").val() },
            coffeesoft: true,
            conf: { datatable: true, pag: 10 },
            attr: {
                id: "tbClient",
...
class Modifier extends App {
                ...
                },
                {
                    ...
                    <div class="flex items-center justify-between p-3 rounded-lg border border-[#2A2E45] ">
                        <div>
                            ...
                            <i class="icon-info-circled-3 text-amber-100 text-sm mr-1"></i>
                            No se incluye en el cálculo por porción</p>
    ...
    async editModifier(id) {
        ...
        // Activar toggle si isExtra es 1
        if (response.data.isExtra == 1) {
            setTimeout(() => {
                $('#toggleAnticipo').prop('checked', true).trigger('change');
            }, 100);
        }
