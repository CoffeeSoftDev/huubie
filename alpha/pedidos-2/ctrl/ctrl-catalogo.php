...
class ctrl extends mdl {
    ...
    function init(){
        ...
        return [
            ...
            'id'         => $_POST['id'],
            'list'       => $orderProducts,
            'order'      => !empty($order) ? $order : ['id' => $_POST['id']],
            'payments'   => $payments,
    ...
    function editProduct() {
        ...
        $company = !empty($_SESSION['COMPANY']) ? $_SESSION['COMPANY'] : 'coffee';
        $sub     = !empty($_SESSION['SUB']) ? $_SESSION['SUB'] : '1';
    ...
    function removeProduct() {
        ...
        $pedidos_id = !empty($_POST['pedidos_id']) ? $_POST['pedidos_id'] : null;
    ...
    function addPayment() {
        ...
        $total_paid = floatval(!empty($_POST['total_paid']) ? $_POST['total_paid'] : 0);
