...
<body class="bg-[#111928] text-white " data-bs-theme="dark">
    ...
    <!-- Init -->
    <script src="<?=PATH_PEDIDOS2?>src/js/app.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_PEDIDOS2?>src/js/catalogo.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_PEDIDOS2?>src/js/personalizado.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_PEDIDOS2?>src/js/reportes.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_PEDIDOS2?>src/js/dashboard.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_PEDIDOS2?>src/js/cierre.js?t=<?php echo time(); ?>"></script>
