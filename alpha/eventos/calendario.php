...
<body data-bs-theme="dark">
    ...
    <div id="mainContainer2"
        class="w-full h-screen transition-all duration-500 bg-[#111928] text-white ">
        <div style="background-color:#111827;" id="root2" class="h-full">
    ...
    <!-- Init -->
    <script src="<?=PATH_EVENTOS?>src/js/app.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_EVENTOS?>src/js/eventos.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_EVENTOS?>src/js/sub-eventos.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_EVENTOS?>src/js/payment.js?t=<?php echo time(); ?>"></script>
    <script src="<?=PATH_EVENTOS?>src/js/calendario.js?t=<?php echo time(); ?>"></script>
</body>
