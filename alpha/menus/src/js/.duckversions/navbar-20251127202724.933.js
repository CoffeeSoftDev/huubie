                ...
                <div class="flex flex-col items-center pt-4 px-4 space-y-2">
                  <p class="text-white font-semibold text-lg mt-3">${this.settings.company}</p>
                    ...
                    <span class="inline-block bg-blue-900/50 text-blue-200 text-[10px] font-semibold px-3 py-1 rounded-full ">
                        <i class="icon-shield-halved mr-1"></i> ${this.settings.role || 'Sin rol'}
                    </span>
                    </div>
                    <div class="w-full text-center  px-3 mt-2 mb-3">
                        <p class="block font-medium text-gray-400 hover:bg-gray-800 hover:text-white transition px-3 rounded-lg cursor-pointer" id="btn_perfil">Mi Perfil</p>
                        <p class="block font-medium text-gray-400 hover:bg-gray-800 hover:text-white transition px-3 rounded-lg cursor-pointer" id="btn_admin">Configuración</p>
                    </div>
