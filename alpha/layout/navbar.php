...
<!-- Navbar -->
<nav
    class="bg-[#1F2A37] fixed top-0 left-0 w-full text-white px-4 py-3 h-16 z-50 shadow flex items-center justify-between">
    <!-- Logo -->
    <div class="flex items-center space-x-2">
        <img src="/alpha/src/img/logo/logo.svg" alt="Logo" class="w-10 h-10" />
