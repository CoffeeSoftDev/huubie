...
<body>
        ...
        <div id="main__content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item fw-bold active">Generador</li>
                </ol>
            </nav>
    ...
    <!-- Módulo Generador -->
    <script src="js/sample_generador.js?t=<?php echo time(); ?>"></script>
    <script src="js/generador.js?t=<?php echo time(); ?>"></script>
</body>
</html>
