...
$(async () => {
    modulosView = new ModulosView(apiFacturador, 'root');
    modulos     = new Modulos(apiFacturador, 'root');
...
class Modulos extends Templates {
    ...
    lsModulos() {
        // MODO FAKE: si hubiera backend -> useFetch({ url:apiFacturador, data:{ opc:'lsModulos' } })
