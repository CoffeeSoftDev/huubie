...
<link rel="stylesheet" href="css/facturador.css?t=<?php echo time(); ?>">
...
<body>
        ...
        <div id="main__content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-muted"><a href="index.php" class="text-decoration-none text-muted">Facturador</a></li>
                    <li class="breadcrumb-item fw-bold active">Catálogos</li>
                </ol>
            </nav>
    ...
    <!-- Módulo Catálogos -->
    <script src="js/sample_catalogos.js?t=<?php echo time(); ?>"></script>
    <script src="js/catalogos.js?t=<?php echo time(); ?>"></script>
</body>
</html>
