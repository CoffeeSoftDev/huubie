...
<body>
        ...
        <div id="main__content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item fw-bold active">Tickets</li>
                </ol>
            </nav>
    ...
    <!-- Módulo Tickets -->
    <script src="js/sample_tickets.js?t=<?php echo time(); ?>"></script>
    <script src="js/tickets.js?t=<?php echo time(); ?>"></script>
</body>
</html>
